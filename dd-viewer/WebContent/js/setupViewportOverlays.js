function setupViewportOverlays(element, data) {
    ...
    var bottomRight = $(childDivs[4]).find('div');
    ...
    function onNewImage(e, eventData) {
        ...
        $(bottomLeft[1]).text("Cant. Imágenes: " + stack.imageIds.length);
        $(bottomLeft[2]).text("Imagen # : " + (stack.currentImageIdIndex + 1) + "/" + stack.imageIds.length);
    ...
    function onImageRendered(e, eventData) {
        ...
        $(bottomLeft[0]).text("Render Time:" + eventData.renderTimeInMs + " ms");
    }
