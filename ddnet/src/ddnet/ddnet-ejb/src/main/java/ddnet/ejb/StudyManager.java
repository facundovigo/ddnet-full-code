...
import ddnet.ejb.dao.LegacyStudyDAO;
...
public class StudyManager implements StudyManagerLocal {
	...
	@EJB
	private LegacyStudyDAO LegacyStudyDAO;
	...
	@Override
	public void removeAllStudyData(LegacyStudy study) {
		LegacyStudyDAO.remove(study);
	}
	@Override
	public void removeAllPatientData(LegacyPatient p) {
		LegacyPatientDAO.remove(p);
	}
	...
	public Collection<Study> getStudiesByPatID(String patID) {
		return studyDAO.getStudiesByPatID(patID);
	}
}
