...
public class abmManager implements abmManagerLocal {
	...
	@EJB private UserInstitutionDAO userInstdao;
	@EJB private InstitutionDAO instdao;
	@EJB private ModalityDAO moddao;
	@EJB private InstanceDAO instancedao;
	@EJB private UserPermissionsDAO permdao;
	...
	@Override
	public void remove(LegacyInstance instance) {
		
		instancedao.remove(instance);
	}
	@Override
