...
function preset_table(){
	...
	$(table).on('dblclick','td',function(){
		...
		break;
		case 8: var dialog='';
				dialog+= '<div id="modPswd" title="Cambiar Contraseña '+user.login+'" align="center"> <br>'	+ 
					...
					buttons:{
						OK:function(){
							if(!$('input#newPassword').val()){
								toastr['warning']('Ingrese una nueva contraseña','NO SE PUDO');
								return;
							}
