...
import ddhemo.ejb.dao.StudyDAO;
import ddhemo.ejb.entities.Configuration;
import ddhemo.ejb.entities.LegacyInstance;
import ddhemo.ejb.entities.LegacySerie;
 ...
 */
@Stateless(mappedName = "ejb/ddhemo/StudyManager")
@LocalBean
